...
export default function Counter() {
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: count % 2 === 0 ? 'royalblue' : 'crimson', /* STEP 2 -- you can do a ternary here, doesn't need curly brackets around it (google to see if number is even or odd (a modulus) */
  };
